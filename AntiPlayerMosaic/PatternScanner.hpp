...
inline constexpr Signature k_signatures[] {
    ...
    //
    //   FindString         60 字节  位移全掩（本就掩好）      命中 1 @0x004B2F50
    //   FindObject         64 字节  位移全掩                  命中 1 @0x01453720
    ...
    },
    {
        ...
        "ObjectActive",
        "48 89 5C 24 08 57 48 83 EC 20 0F B6 FA 48 8B D9 48 85 C9 74 ?? E8 96 70 7F 00 48 85 C0 74 ?? 40 "
